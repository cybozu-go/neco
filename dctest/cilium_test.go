...
func checkCiliumAgentDaemonSet() {
	EventuallyWithOffset(1, func(g Gomega) {
		ds := kubectlGetSafe[appsv1.DaemonSet](g, "--namespace=kube-system", "get", "daemonsets/cilium", "-o=json")
...
func checkCiliumOperatorDeployment() {
	EventuallyWithOffset(1, func(g Gomega) {
		deployment := kubectlGetSafe[appsv1.Deployment](g, "--namespace=kube-system", "get", "deployment/cilium-operator", "-o=json")
...
func checkHubbleRelayDeployment() {
	EventuallyWithOffset(1, func(g Gomega) {
		deployment := kubectlGetSafe[appsv1.Deployment](g, "--namespace=kube-system", "get", "deployment/hubble-relay", "-o=json")
