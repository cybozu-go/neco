...
var CurrentArtifacts = ArtifactSet{
	Images: []ContainerImage{
		...
		{Name: "setup-hw", Repository: "ghcr.io/cybozu-go/setup-hw", Tag: "1.17.2", Private: true},
		...
		{Name: "cilium", Repository: "ghcr.io/cybozu/cilium", Tag: "1.15.11.1-rc.1", Private: false},
