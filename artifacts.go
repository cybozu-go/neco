...
var CurrentArtifacts = ArtifactSet{
	Images: []ContainerImage{
		...
		{Name: "setup-hw", Repository: "quay.io/cybozu/setup-hw", Tag: "1.14.2", Private: true},
		...
		{Name: "cilium", Repository: "quay.io/cybozu/cilium", Tag: "1.12.11.1", Private: false},
		{Name: "cilium-operator-generic", Repository: "quay.io/cybozu/cilium-operator-generic", Tag: "1.12.11.1", Private: false},
		{Name: "hubble-relay", Repository: "quay.io/cybozu/hubble-relay", Tag: "1.12.11.1", Private: false},
	...
	OSImage: OSImage{Channel: "stable", Version: "3510.2.5"},
}
