...
var CurrentArtifacts = ArtifactSet{
	Images: []ContainerImage{
		...
		{Name: "cilium", Repository: "ghcr.io/cybozu/cilium", Tag: "1.14.13.2", Private: false},
		{Name: "cilium-operator-generic", Repository: "ghcr.io/cybozu/cilium-operator-generic", Tag: "1.14.13.1", Private: false},
		{Name: "hubble-relay", Repository: "ghcr.io/cybozu/hubble-relay", Tag: "1.14.13.2", Private: false},
