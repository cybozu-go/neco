...
var CurrentArtifacts = ArtifactSet{
	Images: []ContainerImage{
		{Name: "coil", Repository: "ghcr.io/cybozu-go/coil", Tag: "2.7.0", Private: false},
		...
		{Name: "setup-hw", Repository: "ghcr.io/cybozu-go/setup-hw", Tag: "1.17.0", Private: true},
		...
		{Name: "vault", Repository: "ghcr.io/cybozu/vault", Tag: "1.17.2.1", Private: false},
