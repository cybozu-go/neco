...
var CurrentArtifacts = ArtifactSet{
	Images: []ContainerImage{
		{Name: "coil", Repository: "ghcr.io/cybozu-go/coil", Tag: "2.0.4", Private: false},
		...
		{Name: "cke", Repository: "quay.io/cybozu/cke", Tag: "1.18.8", Private: false},
	...
	CoreOS: CoreOSImage{Channel: "stable", Version: "2605.11.0"},
}
