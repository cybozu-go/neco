...
OPDEB_BINNAMES = argocd kubectl kubeseal kustomize logcli stern tsh kubectl-moco kubectl-accurate amtool
OPDEB_DOCNAMES = argocd kubectl kubeseal kustomize logcli stern teleport moco alertmanager
