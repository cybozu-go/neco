...
var CurrentArtifacts = ArtifactSet{
	Images: []ContainerImage{
		{Name: "cke", Repository: "quay.io/cybozu/cke", Tag: "1.13.0-1"},
		{Name: "etcd", Repository: "quay.io/cybozu/etcd", Tag: "3.3.11-1"},
		{Name: "omsa", Repository: "quay.io/cybozu/omsa", Tag: "18.11.01-1"},
		{Name: "sabakan", Repository: "quay.io/cybozu/sabakan", Tag: "1.1.0-1"},
		{Name: "serf", Repository: "quay.io/cybozu/serf", Tag: "0.8.1-5"},
		{Name: "vault", Repository: "quay.io/cybozu/vault", Tag: "1.0.0-1"},
		{Name: "hyperkube", Repository: "quay.io/cybozu/hyperkube", Tag: "1.13.2-1"},
		{Name: "coil", Repository: "quay.io/cybozu/coil", Tag: "1.0.0-1"},
