...
var CurrentArtifacts = ArtifactSet{
	Images: []ContainerImage{
		{Name: "cke", Repository: "quay.io/cybozu/cke", Tag: "1.16.1", Private: false},
		...
		{Name: "sabakan", Repository: "quay.io/cybozu/sabakan", Tag: "2.4.9", Private: false},
		...
		{Name: "teleport", Repository: "quay.io/cybozu/teleport", Tag: "4.2.0.1", Private: false},
	},
	Debs: []DebianPackage{
