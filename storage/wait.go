...
func (s Storage) WaitRequest(ctx context.Context, revision int64) (req *neco.UpdateRequest, modRev, rev int64, err error) {
	...
	for wr := range ch {
		...
		return req, ev.Kv.ModRevision, wr.Header.Revision, nil
	}

	return nil, 0, 0, errors.New("waitRequest was interrupted")
}
